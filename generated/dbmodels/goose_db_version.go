...
func (o *GooseDBVersion) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("dbmodels: unable to update goose_db_version, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to update goose_db_version row")
	}
...
func (q gooseDBVersionQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to update all for goose_db_version")
	}
...
func (o GooseDBVersionSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to update all in gooseDBVersion slice")
	}
...
func (o *GooseDBVersion) DeleteG() error {
	if o == nil {
		return errors.New("dbmodels: no GooseDBVersion provided for deletion")
	}
...
func (o *GooseDBVersion) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("dbmodels: no GooseDBVersion provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to delete from goose_db_version")
	}
...
func (q gooseDBVersionQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("dbmodels: no gooseDBVersionQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to delete all from goose_db_version")
	}
...
func (o GooseDBVersionSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("dbmodels: no GooseDBVersion slice provided for delete all")
	}
...
func (o GooseDBVersionSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to delete all from gooseDBVersion slice")
	}
