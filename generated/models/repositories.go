...
func (o *Repository) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update repositories, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update repositories row")
	}
...
func (q repositoryQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for repositories")
	}
...
func (o RepositorySlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in repository slice")
	}
...
func (o *Repository) DeleteG() error {
	if o == nil {
		return errors.New("models: no Repository provided for deletion")
	}
...
func (o *Repository) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Repository provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from repositories")
	}
...
func (q repositoryQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no repositoryQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from repositories")
	}
...
func (o RepositorySlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Repository slice provided for delete all")
	}
...
func (o RepositorySlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from repository slice")
	}
...
func (o *Repository) ReloadG() error {
	if o == nil {
		return errors.New("models: no Repository provided for reload")
	}
...
func (o *RepositorySlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty RepositorySlice provided for reload all")
	}
